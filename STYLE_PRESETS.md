...
Curated visual styles for HTML Showcase. Each preset is inspired by real design references — no generic "AI slop" aesthetics. **Abstract shapes only — no illustrations.**
...
| Dark Botanical | Cormorant | Inter | Google |
