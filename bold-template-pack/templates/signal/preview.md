...
- Typography: Source Serif 4; DM Sans; JetBrains Mono; {typography.label.fontFamily}
...
- Signature move: DM Sans for body and JetBrains Mono for every timestamp, kicker, label, and chrome element.
